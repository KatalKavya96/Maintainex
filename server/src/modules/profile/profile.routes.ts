...
import { changePasswordSchema, resetWorkspaceSchema, updateProfileSchema, usernameAvailabilitySchema, verifyEmailOtpSchema } from "./profile.validation";
...
profileRoutes.post("/email-verification/send", asyncHandler(controller.sendEmailVerification));
profileRoutes.post("/email-verification/verify", validate(verifyEmailOtpSchema), asyncHandler(controller.verifyEmail));
